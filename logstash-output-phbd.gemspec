...
Gem::Specification.new do |spec|
  spec.name = 'logstash-output-phbd'
  spec.version = '0.0.1'
  spec.licenses = ['Apache License (2.0)']
  spec.summary = 'This plugin for output to phbd rest service.'
  spec.description = 'This gem is a logstash plugin required to be installed ' \
